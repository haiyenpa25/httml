{{--
Partial Modal Thêm Thành Viên cho Ban Thanh Tráng
File lưu tại: resources/views/_ban_thanh_trang/partials/_modal_them_thanh_vien.blade.php
--}}
...
<div class="modal fade" id="modal-them-thanh-vien">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-them-thanh-vien" action="{{ route('api.ban_thanh_trang.them_thanh_vien') }}" method="POST">
                @csrf

...
@section('title', 'Thêm Mới Hộ Gia Đình')
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Thông Tin Hộ Gia Đình</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('_ho_gia_dinh.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="so_ho">Số Hộ</label>
                                    <input type="text" class="form-control" id="so_ho" name="so_ho" placeholder="Nhập số hộ">
                                </div>
                                <div class="form-group">

                ...
                <div class="card">
                    <div class="card-body d-flex justify-content-between">
                        <div class="btn-group">
                            ...
                            <a href="{{ route('_ban_trung_lao.form_ban_trung_lao') }}" class="btn btn-success">
...
<script>
    $(function() {
        ...
        $('.update-count').on('click', function() {
            ...
            if (type === 'bn') {
                // Thêm dâng hiến cho Ban Trung Lão
        ...
        $(document).on('click', '.remove-diem-manh', function() {
            // Không xóa nếu chỉ còn 1 mục
            if ($('.diem-manh-item').length > 1) {
                $(this).closest('.diem-manh-item').remove();
            } else {
                // Nếu chỉ còn 1 mục thì xóa nội dung

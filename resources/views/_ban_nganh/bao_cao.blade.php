...
@section('content')
    @php
        ...
        $config = $config ?? config('ban_nganh.trung_lao');
    @endphp
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <form id="report-filter-form" method="GET" action="{{ route('_bao_cao.ban_nganh.trung_lao') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @forelse($buoiNhomHT as $index => $buoiNhom)
                                        <div class="progress-group">
                                            ...
                                            <span class="float-right"><b>{{ $buoiNhom->{$config['quantity_field']} }}</b> tín hữu</span>
                                            <div class="progress progress-sm">
                                                <div class="progress-bar bg-primary"
                                                    style="width: {{ min(($buoiNhom->{$config['quantity_field']} / 40) * 100, 100) }}%">
                                                </div>
                                            </div>
                                        </div>
                                    @empty
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" style="background-color: #4b545c; color: white;">
                            <h5 class="card-title">Biểu đồ tín hữu sinh hoạt {{ $banNganh->ten ?? 'Ban Ngành' }} | Thứ 7 | Vào lúc 18:30</h5>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                        class="fas fa-minus"></i></button>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="text-center">
                                        <strong>BIỂU ĐỒ TÍN HỮU SINH HOẠT {{ strtoupper($banNganh->ten ?? 'BAN NGÀNH') }}</strong>
                                    </p>
                                    <div class="chart">
                                        ...
                                        <div class="progress-group">
                                            ...
                                            <div class="progress progress-sm">
                                                <div class="progress-bar bg-info"
                                                    style="width: {{ min(($buoiNhom->{$config['quantity_field']} / 30) * 100, 100) }}%">
                                                </div>
                                            </div>
                                        </div>
                                    @empty
                                        <div class="alert alert-info">
                                            Không có dữ liệu buổi nhóm {{ $banNganh->ten ?? 'Ban Ngành' }} trong tháng này
                                        </div>
                                    @endforelse
                                    ...
                                    <tbody>
                                        @forelse($buoiNhomHT as $index => $buoiNhom)
                                            <tr>
                                                ...
                                                <td>{{ $buoiNhom->{$config['quantity_field']} }}</td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" style="background-color: #4b545c; color: white;">
                            <h3 class="card-title">Sinh Hoạt {{ $banNganh->ten ?? 'Ban Ngành' }} (Thứ 7) - Tháng {{ $month }}/{{ $year }}</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                        class="fas fa-minus"></i></button>
                            </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p class="font-italic">Trưởng {{ $banNganh->ten ?? 'Ban Ngành' }}</p>
                                </div>
                                <div class="col-md-6 text-right">
...
@include('_ban_nganh.scripts._scripts_bao_cao')
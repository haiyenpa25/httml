...
@section('title', 'Phân Công Chi Tiết - ' . ($banNganh->ten ?? 'Ban Ngành'))
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('_ban_nganh.trung_lao.phan_cong_chi_tiet') }}" method="GET" id="filter-form">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('_ban_nganh.trung_lao.phan_cong_chi_tiet') }}" class="btn btn-default">
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Danh sách thành viên {{ $banNganh->ten ?? 'Ban Ngành' }}
                    </h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
    ...
    <div class="modal fade" id="modal-phan-cong">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form-phan-cong" action="{{ route('api.ban_nganh.trung_lao.phan_cong_nhiem_vu') }}" method="POST">
                    @csrf
...
@include('_ban_nganh.scripts._scripts_phan_cong_chi_tiet')
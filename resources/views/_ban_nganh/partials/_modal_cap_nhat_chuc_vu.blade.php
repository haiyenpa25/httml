{{-- 
    Partial Modal Cập Nhật Chức Vụ cho Ban Ngành 
    File lưu tại: resources/views/_ban_nganh/partials/_modal_cap_nhat_chuc_vu.blade.php
--}}
...
<div class="modal fade" id="modal-edit-chuc-vu">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-sua-chuc-vu" action="{{ route('api.ban_nganh.trung_lao.cap_nhat_chuc_vu') }}" method="POST">
                @csrf
                @method('PUT')

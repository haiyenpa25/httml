    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            let tableDieuHanh = initializeDataTable(
                '#ban-dieu-hanh-table',
                "{{ route('api.ban_nganh.trung_lao.dieu_hanh_list') }}",
                [
                    {
                        data: null,
                            ...
                            return `
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-sm btn-info btn-edit-chuc-vu" 
                                                                    ...
                                                                    data-id="${row.tin_huu_id}" data-ban-id="{{ $banNganh->id }}"
            ...
            let tableBanVien = initializeDataTable(
                '#ban-vien-table',
                "{{ route('api.ban_nganh.trung_lao.ban_vien_list') }}",
                [
                    {
                        data: null,
                        render: function (data, type, row, meta) {
            ...
            $('#confirm-delete').click(function () {
                ...
                $.ajax({
                    url: "{{ route('api.ban_nganh.trung_lao.xoa_thanh_vien') }}",
                    method: 'POST',
                    data: data,
                    dataType: 'json'
                })

...
@section('title', 'Phân Công Buổi Nhóm - ' . ($banNganh->ten ?? 'Ban Ngành'))
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <form action="{{ route('_ban_nganh.trung_lao.phan_cong') }}" method="GET">
                        <div class="row">
                            <div class="col-md-4">
            ...
            <div class="card card-primary">
                ...
                <form id="buoi-nhom-form" action="{{ route('api.ban_nganh.trung_lao.update_buoi_nhom', ['buoiNhom' => ':id']) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
...
@include('_ban_nganh.scripts._scripts_phan_cong')
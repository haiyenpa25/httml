...
<script>
  ...
  if (banNganhSelect.length) banNganhSelect.select2({
    theme: 'bootstrap4'
  });
  if (tinHuuHdctSelect.length) tinHuuHdctSelect.select2({
    theme: 'bootstrap4'
  });
  if (tinHuuDoKtSelect.length) tinHuuDoKtSelect.select2({
    theme: 'bootstrap4'
  });
  if ($('#lich_buoi_nhom_id').length) $('#lich_buoi_nhom_id').select2({
    theme: 'bootstrap4'
  });
  if ($('#dien_gia_id').length) $('#dien_gia_id').select2({
    theme: 'bootstrap4'
  });
  ...
  if (editId && initialBanNganhId) {
    ...
    setTimeout(() => {
      ...
      ' }}'; // Lấy từ biến $buoiNhom trong view edit

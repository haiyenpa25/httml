...
@section('title', 'Điểm Danh - Ban Cơ Đốc Giáo Dục')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('_ban_co_doc_giao_duc.diem_danh') }}" method="GET" id="filter-form">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('_ban_co_doc_giao_duc.diem_danh') }}" class="btn btn-default">
            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                    @if($selectedBuoiNhom)
                        <form id="attendance-form" action="{{ route('api.ban_co_doc_giao_duc.luu_diem_danh') }}" method="POST">
                            @csrf
    ...
    <div class="modal fade" id="modal-them-buoi-nhom">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('api.ban_co_doc_giao_duc.them_buoi_nhom') }}" method="POST" id="add-buoi-nhom-form">
                    @csrf
...
@include('_ban_co_doc_giao_duc.scripts._scripts_diem_danh')
    ...
    <script>
        $(function () {
            ...
            $('.update-count').on('click', function (e) {
                ...
                $.ajax({
                    url: '{{ route("_ban_co_doc_giao_duc.update_thamdu_trung_lao") }}',
                    type: 'POST',
                    data: data,
                    dataType: 'json',
                    beforeSend: function () {
            ...
            // Khởi tạo DataTable cho bảng Nhóm tối thứ 7 (Ban Cơ Đốc Giáo Dục)
            try {
            ...
            $('#add-diem-manh-form').on('submit', function (e) {
                ...
                $.ajax({
                    url: '{{ route("_ban_co_doc_giao_duc.save_danhgia_trung_lao") }}',
                    method: 'POST',
                    data: formData,
                    dataType: 'json',
                    beforeSend: function () {
            ...
            $(document).on('click', '.remove-danh-gia', function () {
                ...
                $.ajax({
                    url: '{{ route("api.ban_co_doc_giao_duc.xoa_danh_gia", ["id" => "__ID__"]) }}'.replace('__ID__', id),
                    method: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
            ...
            $(document).on('click', '.remove-kiennghi', function () {
                ...
                if (id != '0') {
                    ...
                    $.ajax({
                        url: '{{ route("api.ban_co_doc_giao_duc.xoa_kien_nghi", ["id" => "__ID__"]) }}'.replace('__ID__', id),
                        method: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },

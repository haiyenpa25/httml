...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('_ban_' . $banType . '.index') }}">{{ $config['name'] }}</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @include('_ban_co_doc_giao_duc.partials._modal_them_thanh_vien', ['config' => $config, 'tinHuuList' => $tinHuuList])

            <!-- Modal Chỉnh Sửa Chức Vụ -->
            @include('_ban_co_doc_giao_duc.partials._modal_cap_nhat_chuc_vu', ['banType' => $banType])

            <!-- Modal Xóa Thành Viên -->
            @include('_ban_co_doc_giao_duc.partials._modal_xoa_thanh_vien', ['config' => $config])
        </div>
    </section>
@endsection

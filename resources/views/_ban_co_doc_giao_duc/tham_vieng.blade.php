...
@section('title', 'Thăm Viếng - Ban Cơ Đốc Giáo Dục')
    ...
    <div class="modal fade" id="modal-them-tham-vieng">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('api.ban_co_doc_giao_duc.them_tham_vieng') }}" method="POST"
                    id="form-them-tham-vieng">
                    @csrf
...
@include('_ban_co_doc_giao_duc.scripts._scripts_tham_vieng')
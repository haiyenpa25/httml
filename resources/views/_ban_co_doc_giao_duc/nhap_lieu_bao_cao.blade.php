...
@section('title', 'Nhập liệu Báo Cáo Ban Cơ Đốc Giáo Dục')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            ...
            @include('_ban_co_doc_giao_duc.partials._ban_co_doc_giao_duc_navigation')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Nhập liệu Ban Cơ Đốc Giáo Dục</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="filter-form" method="GET" action="{{ route('_ban_co_doc_giao_duc.nhap_lieu_bao_cao') }}">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="buoi_nhom_type" name="buoi_nhom_type" class="form-control">
                                        <option value="1" {{ isset($buoiNhomType) && $buoiNhomType == 1 ? 'selected' : '' }}>Ban Cơ Đốc Giáo Dục (Nhóm tối thứ 7)</option>
                ...
                <div class="card-body">
                    <div class="tab-content" id="baocao-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="buoinhom" role="tabpanel">
                            ...
                            <form id="thamdu-form" method="POST" action="{{ route('_ban_co_doc_giao_duc.save_thamdu_trung_lao') }}">
                                @csrf
                                ...
                                <!-- Nhóm tối thứ 7 (nếu đang ở tab Ban Cơ Đốc Giáo Dục) -->
                                @if ($buoiNhomType == 1)
                                    <div class="card card-primary card-outline">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <i class="fas fa-users"></i> Nhóm tối thứ 7 (Ban Cơ Đốc Giáo Dục)
                                            </h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                    <i class="fas fa-minus"></i>
                        ...
                        <div class="tab-pane fade" id="kehoach" role="tabpanel">
                            <form id="kehoach-form" method="POST" action="{{ route('_ban_co_doc_giao_duc.save_kehoach_trung_lao') }}">
                                @csrf
                                                            ...
                                                            <td>
                                                                <select class="form-control" name="kehoach[{{ $index }}][nguoi_phu_trach_id]">
                                                                    ...
                                                                    @if ($tinHuuTrungLao->isEmpty())
                                                                        <option value="">Không có tín hữu nào trong Ban Cơ Đốc Giáo Dục</option>
                                                                    @else
                        ...
                        <div class="tab-pane fade" id="kiennghi" role="tabpanel">
                            <form id="kiennghi-form" method="POST" action="{{ route('_ban_co_doc_giao_duc.save_kiennghi_trung_lao') }}">
                                @csrf
                                <input type="hidden" name="month" value="{{ $month }}">
                                <input type="hidden" name="year" value="{{ $year }}">
                                <input type="hidden" name="ban_nganh_id" value="1">

    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('_ban_co_doc_giao_duc.phan_cong_chi_tiet') }}" method="GET" id="filter-form">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('_ban_co_doc_giao_duc.phan_cong_chi_tiet') }}" class="btn btn-default">
    ...
    <div class="modal fade" id="modal-phan-cong">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form-phan-cong" action="{{ route('api.ban_co_doc_giao_duc.phan_cong_nhiem_vu') }}" method="POST">
                    @csrf

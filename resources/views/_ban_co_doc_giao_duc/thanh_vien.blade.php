...
@section('title', 'Quản lý Thành viên Ban Cơ Đốc Giáo Dục')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Quản lý Thành viên Ban Cơ Đốc Giáo Dục</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Trang chủ</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('_ban_co_doc_giao_duc.index') }}">Ban Cơ Đốc Giáo
                                Dục</a></li>

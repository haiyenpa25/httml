@extends('layouts.app')
@section('title', 'Báo Cáo Ban Cơ Đốc Giáo Dục')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Báo Cáo Ban Cơ Đốc Giáo Dục</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#">Báo Cáo</a></li>
                        <li class="breadcrumb-item active">Ban Cơ Đốc Giáo Dục</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <form id="report-filter-form" method="GET" action="{{ route('_bao_cao.ban_co_doc_giao_duc') }}">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p class="font-italic">Trưởng Ban Cơ Đốc Giáo Dục</p>
                                </div>
                                <div class="col-md-6 text-right">

        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('_ban_nganh.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                @foreach ([
                                    'am_thuc' => 'Ẩm Thực', 'cau_nguyen' => 'Cầu Nguyện', 'chung_dao' => 'Chứng Đạo',
                                    'co_doc_giao_duc' => 'Cơ Đốc Giáo Dục', 'dan' => 'Đàn', 'hau_can' => 'Hậu Cần',
                                    'hat_tho_phuong' => 'Hát Thờ Phượng', 'khanh_tiet' => 'Khánh Tiết',
                                    'ky_thuat_am_thanh' => 'Kỹ Thuật - Âm Thanh', 'le_tan' => 'Lễ Tân',
                                    'may_chieu' => 'Máy Chiếu', 'tham_vieng' => 'Thăm Viếng', 'trat_tu' => 'Trật Tự',
                                    'truyen_giang' => 'Truyền Giảng', 'truyen_thong_may_chieu' => 'Truyền Thông - Máy Chiếu'
                                ] as $key => $label)
                                <li class="nav-item">
                                    <a href="{{ route('_ban_' . $key . '.index') }}" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                @foreach ([
                                    'thanh_nien' => 'Thanh Niên', 'thanh_trang' => 'Thanh Tráng',
                                    'thieu_nhi_au' => 'Thiếu Nhi Ấu', 'trung_lao' => 'Trung Lão'
                                ] as $key => $label)
                                <li class="nav-item">
                                    <a href="{{ route('_ban_' . $key . '.index') }}" class="nav-link">
                                        <i class="far fa-dot-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                        ...
                        <p>Báo Cáo<i class="fas fa-angle-left right"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">

                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2bs4" id="ban_nganh_select"
                            onchange="location.href='{{ route('ban_muc_vu.index') }}?ban_nganh_id=' + this.value">

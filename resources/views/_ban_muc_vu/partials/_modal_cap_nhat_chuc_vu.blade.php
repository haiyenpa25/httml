<div class="modal fade" id="modal-edit-chuc-vu">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-sua-chuc-vu" action="{{ route('api.ban_muc_vu.cap_nhat_chuc_vu') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <input type="hidden" name="tin_huu_id" id="edit_tin_huu_id">
                    <input type="hidden" name="ban_nganh_id" id="edit_ban_nganh_id" value="{{ $ban_nganh_id }}">

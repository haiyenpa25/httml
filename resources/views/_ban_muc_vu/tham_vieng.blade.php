...
@section('title', 'Thăm Viếng - {{ $banNganh->ten }}')
        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2bs4" id="ban_nganh_select"
                            onchange="location.href='{{ route('ban_muc_vu.tham_vieng') }}?ban_nganh_id=' + this.value">
            ...
            <div class="action-buttons-container">
                ...
                <div class="button-row">
                    <a href="{{ route('ban_muc_vu.index', ['ban_nganh_id' => $banNganh->id]) }}"
                        class="action-btn btn-primary-custom">
                        <i class="fas fa-home"></i> Trang chính
                    </a>
                    <a href="{{ route('ban_muc_vu.diem_danh', ['ban_nganh_id' => $banNganh->id]) }}"
                        class="action-btn btn-success-custom">
                        <i class="fas fa-clipboard-check"></i> Điểm danh
                    </a>
                    <a href="{{ route('ban_muc_vu.tham_vieng', ['ban_nganh_id' => $banNganh->id]) }}"
                ...
                <div class="button-row">
                    <a href="{{ route('ban_muc_vu.phan_cong', ['ban_nganh_id' => $banNganh->id]) }}"
                        class="action-btn btn-warning-custom">
                        <i class="fas fa-tasks"></i> Phân công
                    </a>
                    <a href="{{ route('ban_muc_vu.phan_cong_chi_tiet', ['ban_nganh_id' => $banNganh->id]) }}"
                        class="action-btn btn-info-custom">
                        <i class="fas fa-clipboard-list"></i> Chi tiết PC
                    </a>
                    <a href="{{ route('ban_muc_vu.nhap_lieu_bao_cao', ['ban_nganh_id' => $banNganh->id]) }}"
                        class="action-btn btn-success-custom">
    ...
    <div class="modal fade" id="modal-them-tham-vieng">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('api.ban_muc_vu.them_tham_vieng', ['ban_nganh_id' => $banNganh->id]) }}"
                    method="POST" id="form-them-tham-vieng">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4" name="nguoi_tham_id" required>
                                ...
                                @foreach($thanhVienBanNganh as $thanhVien)
...
@include('_ban_muc_vu.scripts._scripts_tham_vieng', ['ban_nganh_id' => $banNganh->id])
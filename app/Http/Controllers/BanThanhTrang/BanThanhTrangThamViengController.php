...
class BanThanhTrangThamViengController extends Controller
{
    ...
    {
        $banThanhTrang = BanNganh::where('ten', 'Ban Trung Lão')->first();
        if (!$banThanhTrang) {
        ...
        return view('_ban_thanh_trang.tham_vieng', compact(
            'banThanhTrang',

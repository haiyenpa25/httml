...
use App\Http\Controllers\BanThanhTrang\BanThanhTrangThanhVienController;
use App\Http\Controllers\BanThanhTrang\BanThanhTrangThamViengController;
use App\Http\Controllers\BanThanhTrang\BanThanhTrangBaoCaoController;
...
class BanThanhTrangController extends Controller
{
    ...
    public function __construct(
        BanThanhTrangThanhVienController $thanhVienController,
        BanThanhTrangThamViengController $thamViengController,
        BanThanhTrangBaoCaoController $baoCaoController
    ) {
    ...
    {
        return $this->baoCaoController->formBaoCaoBanThanhTrang($request);
    }
    ...
    {
        return $this->baoCaoController->baoCaoBanThanhTrang($request);
    }
     ...
     */
    public function luuBaoCaoBanThanhTrang(Request $request): JsonResponse
    {
        return $this->baoCaoController->luuBaoCaoBanThanhTrang($request);
    }

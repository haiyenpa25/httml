...
Route::middleware(['auth', 'checkRole:quan_tri,truong_ban'])
    ...
    ->group(function () {
        ...
        Route::get('bao-cao-ban-thanh-trang', [BanTrungLaoController::class, 'baoCaoBanTrungLao'])->name('bao_cao_ban_thanh_trang');
...
Route::prefix('bao-cao')
    ...
    ->name('_bao_cao.')
    ->group(function () {
        Route::get('ban-thanh-trang', [App\Http\Controllers\BanTrungLao\BaoCaoBanTrungLaoController::class, 'baoCaoBanTrungLao'])
